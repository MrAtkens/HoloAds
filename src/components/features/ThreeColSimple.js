...
const Card = styled.a`
  ...
  .link {
    ${tw`mt-auto inline-flex items-center pt-5 text-sm font-bold leading-none transition duration-300`}
    .icon {
      ${tw`ml-2 w-4`}
    }
  }
...
const HighlightedText = tw.span`text-gray-100 px-4 transform -skew-x-12 inline-block`;
