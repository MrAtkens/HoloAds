...
const SubheadingSpan = tw.span`tracking-wider text-sm font-medium`;
            ...
            <Statistics>
              {statistics.map((statistic, index) => (
                <Statistic key={index}>
                  ...
                  <Key style={{color: color}}>{statistic.key}</Key>
                </Statistic>
              ))}
            </Statistics>
            <PrimaryButton style={{backgroundColor: color}} as="a" href={primaryButtonUrl}>
              {primaryButtonText}
            </PrimaryButton>
          </TextContent>
        </TextColumn>
