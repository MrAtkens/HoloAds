...
const SubheadingFull = tw.span`tracking-wider text-sm font-medium`;
const HighlightedText = tw.span`bg-primary-500 text-gray-100 px-4 transform -skew-x-12 inline-block`;
const HighlightedTextInverse = tw.span`bg-gray-100 text-primary-500 px-4 transform -skew-x-12 inline-block`;
const DescriptionFull = tw.span`inline-block mt-8`;
  ...
  return (
    <Container>
      <ContentWithPaddingXl>
        <Column>
          <HeaderContent>
            <Subheading><SubheadingFull style={{color: color}}>FAQS</SubheadingFull></Subheading>
            <Heading>У вас есть <HighlightedText style={{backgroundColor: color}}>вопросы ?</HighlightedText></Heading>
